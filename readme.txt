...
= 1.0.7 - 01-09-2025 =
* Video Container styling for full div height video backgrounds
* Set initial sizes for the Elementor Panel and Navigator windows

= 1.0.6 - 01-07-2025 =
* Margin type adjustments for DCE Repeater blocks
...
= 1.0.3 - 12-04-2024 =
* Added page Wordpress template files

= 1.0.2 - 12-04-2024 =
* Removed Search Form Styles in favor of the udpated Search and Filter builder
* Additional Elemetor UI and Style overrides
